...
public class EjercicioExtra5 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Tipo de obra social.");
        ...
        switch (letra) {
            case 'A':
                ...
                System.out.println("El costo de su tratamiento es: " + precio * 0.5);
                break;
            case 'B':
                System.out.println("El costo de su tratamiento es: " + precio * 0.65);
                
                break;
            case 'C':
                System.out.println("El costo de su tratamiento es: " + precio);
